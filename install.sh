...
declare -A gotools
gotools["gf"]="go install -v github.com/tomnomnom/gf"
gotools["qsreplace"]="go install -v github.com/tomnomnom/qsreplace"
gotools["Amass"]="go install -v github.com/OWASP/Amass/v3/...@v3.20.0"
gotools["ffuf"]="go install -v github.com/ffuf/ffuf"
gotools["github-subdomains"]="go install -v github.com/gwen001/github-subdomains"
gotools["gitlab-subdomains"]="go install github.com/gwen001/gitlab-subdomains"
gotools["nuclei"]="go install -v github.com/projectdiscovery/nuclei/v2/cmd/nuclei"
gotools["anew"]="go install -v github.com/tomnomnom/anew@latest"
gotools["notify"]="go install -v github.com/projectdiscovery/notify/cmd/notify"
gotools["unfurl"]="go install -v github.com/tomnomnom/unfurl"
gotools["httpx"]="go install -v github.com/projectdiscovery/httpx/cmd/httpx"
gotools["github-endpoints"]="go install -v github.com/gwen001/github-endpoints"
gotools["dnsx"]="go install -v github.com/projectdiscovery/dnsx/cmd/dnsx"
gotools["subjs"]="go install -v github.com/lc/subjs"
gotools["Gxss"]="go install -v github.com/KathanP19/Gxss"
gotools["katana"]="go install github.com/projectdiscovery/katana/cmd/katana"
gotools["crlfuzz"]="go install -v github.com/dwisiswant0/crlfuzz/cmd/crlfuzz"
gotools["dalfox"]="go install -v github.com/hahwul/dalfox/v2"
gotools["puredns"]="go install -v github.com/d3mondev/puredns/v2"
gotools["interactsh-client"]="go install -v github.com/projectdiscovery/interactsh/cmd/interactsh-client"
gotools["analyticsrelationships"]="go install -v github.com/Josue87/analyticsrelationships"
gotools["gotator"]="go install -v github.com/Josue87/gotator"
gotools["roboxtractor"]="go install -v github.com/Josue87/roboxtractor"
gotools["mapcidr"]="go install -v github.com/projectdiscovery/mapcidr/cmd/mapcidr"
gotools["ipcdn"]="go install -v github.com/six2dez/ipcdn"
gotools["dnstake"]="go install -v github.com/pwnesia/dnstake/cmd/dnstake"
gotools["gowitness"]="go install -v github.com/sensepost/gowitness"
gotools["tlsx"]="go install github.com/projectdiscovery/tlsx/cmd/tlsx"
gotools["gitdorks_go"]="go install -v github.com/damit5/gitdorks_go"
gotools["smap"]="go install -v github.com/s0md3v/smap/cmd/smap"
gotools["dsieve"]="go install -v github.com/trickest/dsieve"
gotools["inscope"]="go install github.com/tomnomnom/hacks/inscope"
gotools["rush"]="go install github.com/shenwei356/rush"
gotools["enumerepo"]="go install github.com/trickest/enumerepo"
gotools["Web-Cache-Vulnerability-Scanner"]="go install -v github.com/Hackmanit/Web-Cache-Vulnerability-Scanner"
gotools["subfinder"]="go install -v github.com/projectdiscovery/subfinder/v2/cmd/subfinder"
gotools["byp4xx"]="go install -v github.com/lobuhi/byp4xx"
